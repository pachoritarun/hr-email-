...
<head>
  ...
  <style type="text/css">
    @media only screen and (max-width: 640px) {
      ...
      .welcome-script { font-size: 36px !important; }
    }
  </style>
</head>
<body style="margin: 0; padding: 0; background-color: #ffffff; font-family: 'Plus Jakarta Sans', 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;">
  <!-- Outer Wrapper Table: Clean White Background to Eliminate Side Black Borders -->
  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #ffffff; margin: 0; padding: 12px 0;">
    <tr>
      <td align="center" valign="top" style="padding: 0 8px;">
        
        <!-- Main Email Container Card -->
        <table class="main-table" width="620" border="0" cellpadding="0" cellspacing="0" style="width: 620px; max-width: 620px; margin: 0 auto; background: #b8001f; background: linear-gradient(160deg, #9e0017 0%, #c8102e 45%, #880012 100%); border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.15); border: 1px solid rgba(184,0,31,0.2);">
          
          <!-- Row 1: Top White Rounded Header Pill -->
          <tr>
            <td align="center" style="padding: 0 20px;">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 480px; margin: 0 auto; background-color: #ffffff; border-radius: 0 0 18px 18px; box-shadow: 0 4px 14px rgba(0,0,0,0.12);">
                <tr>
                  <td align="center" style="padding: 8px 16px;">
                    ${
                      bannerLogoUrl
                        ? `<img src="${bannerLogoUrl}" alt="JECRC University Header" width="420" style="display: block; width: 100%; max-width: 420px; height: auto; border: 0;" />`
                        : `
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td align="center" valign="middle" style="width: 24%; padding: 4px 8px; text-align: center;">
                              <div style="font-family: Georgia, serif; font-size: 26px; font-weight: bold; color: #c8102e; line-height: 1;">27</div>
          ...
          <!-- Row 2: "Welcome Aboard" Headline (Image with Fallback Font for Gmail/Outlook) -->
          <tr>
            <td align="center" style="padding: 22px 20px 12px 20px;">
              ${
                welcomeAboardUrl
                  ? `<img src="${welcomeAboardUrl}" alt="Welcome Aboard" width="280" style="display: block; margin: 0 auto; max-width: 280px; width: 100%; height: auto; border: 0;" />`
                  : `
                  <span class="welcome-script" style="font-family: 'Brush Script MT', 'Great Vibes', 'Caveat', cursive; font-size: 46px; color: #ffffff; line-height: 1.2; text-shadow: 0 2px 8px rgba(0,0,0,0.3); display: block;">
                    Welcome Aboard
                  </span>
                  `
              }
            ...
            <td align="center" style="padding: 0 24px;">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right" valign="bottom" style="width: 30%; padding-bottom: 28px; padding-right: 16px;">
                    <div style="height: 90px; width: 2px; background-color: rgba(255,255,255,0.45); margin-left: auto;"></div>
                  </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="padding-bottom: 0;">
                          <div class="photo-frame" style="width: 235px; height: 260px; border-radius: 120px 120px 0 0; background-color: #ffffff; overflow: hidden; border: 4px solid #ffffff; box-shadow: 0 10px 25px rgba(0,0,0,0.25);">
                            <img src="${photoUrl}" alt="${escapeHtml(name)}" width="235" height="260" style="display: block; width: 100%; height: 100%; object-fit: cover; border-radius: 116px 116px 0 0; border: 0;" />
                          </div>
                        </td>
                      </tr>
                    </table>
                  ...
                  <td align="left" valign="bottom" style="width: 30%; padding-bottom: 28px; padding-left: 16px;">
                    <div style="height: 90px; width: 2px; background-color: rgba(255,255,255,0.45); margin-right: auto;"></div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td align="center" style="padding: 0 18px 22px 18px;">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #f1f2f5; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,0.12);">
                <tr>
                  <td class="content-padding" style="padding: 26px 32px 32px 32px;">
                    ...
                    <!-- Divider -->
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 18px 0 20px 0;">
                      <tr>
          ...
          <tr>
            <td align="center" style="padding: 0 20px 20px 20px;">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="font-size: 11px; color: rgba(255,255,255,0.8); line-height: 1.6; text-align: center;">
